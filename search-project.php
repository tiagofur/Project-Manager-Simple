        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 border-right-form">
                    ...
                    <form action="php\search-project.php" method="post" id=form-regster>
                        ...
                        <button type="buttom" class="btn btn-light" id="btn_save_project" name="btn_save_project">Buscar</button>
                        ...
                        <?php
                            if($erro == 2){
                            echo '<font color="#FF0000">Projeto no registrado, cambie su busca.</font>';
                        }
                        ?>
